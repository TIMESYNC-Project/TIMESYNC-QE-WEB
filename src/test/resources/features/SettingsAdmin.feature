...
#    And Admin click Settings button
#    When Admin input start office hours to 08 and 00
...
#    And Admin successfully on landing page
#    And Admin click Settings button
#    When Admin input end office hours to 15 and 00
...
#    And Admin successfully on landing page
#    And Admin click Settings button
#    When Admin input set employee annual leaves to 08
...
#    And Admin click Settings button
#    When Admin input start office hours to 08 and 00
#    And Admin input end office hours to 15 and 00
#    And Admin input set office start hours tolerancy to 25
#    And Admin input set employee annual leaves to 08
