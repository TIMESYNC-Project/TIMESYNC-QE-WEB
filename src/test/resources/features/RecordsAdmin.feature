...
#    And Admin click on selected employee name record
#    And Admin click Create Attendance button
##    When Admin input 17022023 on date start field //nanti diganti
...
#    And Admin click on selected employee name record
#    And Admin click Create Attendance button
##    When Admin input 20022023 on date end field //nanti diganti
...
##    And Admin input 20022023 on date start field //nanti diganti
...
##    And Admin input 25022023 on date start field //nanti diganti
##    And Admin input 27022023 on date end field //nanti diganti
